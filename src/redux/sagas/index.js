...
function* searchMovies(obj){
    const records = yield fetch(`https://api.themoviedb.org/3/search/movie?api_key=41fdcc8f626c2582cb4c690e91588abc&query=${obj.payload}&language=en-US&sort_by=popularity.desc&include_adult=false`)
    .then(response => response.json());
